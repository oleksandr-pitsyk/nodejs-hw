...
export const getNoteById = async (req, res) => {
  ...
  const note = await Note.findOne({
    _id: noteId, // Пошук по id нотатки
    userId: req.user._id, // Пошук по id користувача
  });
...
export const createNote = async (req, res) => {
  ...
  // Потрібно також вказати, якому користувачу належить нотатка.
  // Для цього використаємо властивість req.user, яку ми отримуємо завдяки middleware authenticate.
  const note = await Note.create({
    ...req.body, // розпилюємо тіло запиту
    userId: req.user._id, // додаємо id користувача
  });
